...
public:
  ...
  void mouseWheelMove(
      [[maybe_unused]] const juce::MouseEvent& event,
      [[maybe_unused]] const juce::MouseWheelDetails& wheel) override {}
...
juce::Font MainLookAndFeel::getLabelFont([[maybe_unused]] juce::Label&) {
  return Fonts::getFont();
}